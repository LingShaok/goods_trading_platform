...
public class OrderUtil {
    public static class SnowFlake {
        private static final long twepoch = 1609430700000L;//开始时间截 (2021-05-01)
        private static final long workerIdBits = 5L;//机器id所占的位数
        private static final long datacenterIdBits = 5L;//数据标识id所占的位数
        private static final long maxWorkerId = -1L ^ (-1L << workerIdBits);//支持的最大机器id，结果是31
        ...
        private static long workerId;//工作机器ID(0~31)
        private static long datacenterId;//数据中心ID(0~31)
        private static long sequence = 0L;//毫秒内序列(0~4095)
